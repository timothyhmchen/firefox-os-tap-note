      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="brick-1.0.1.byob.min.js.html">brick-1.0.1.byob.min.js</a></li>
          ...
          <div class="scrollspy">
            <ul class="nav nav-list bs-docs-sidenav affix-top">
              <li><a href="#Platform"><i class="alert alert-success"></i><span>Platform</span></a>
              </li>
            </ul>
          </div>
        </div>
